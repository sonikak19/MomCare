...
if (selected == 'About us'):
    ...
    st.title("Welcome to MomCare")
    st.write("At MomCare, our mission is to revolutionize healthcare by offering innovative solutions through predictive analysis. "
